          ...
          >
            {items.map((item, idx) => (
              ...
              >
                ...
                >
                  <div className="text-terminal-green h-4 w-4">{item.icon}</div>
                </Link>
              </motion.div>
            ))}
          </motion.div>
...
const FloatingDockDesktop = ({
  ...
  const mouseX = useMotionValue(Infinity); // Use `const`
  return (
    <motion.div
...
function IconContainer({
  ...
  const ref = useRef<HTMLDivElement>(null); // Use `const`
    ...
    <Link href={href}>
      ...
      >
        ...
        <motion.div
          ...
          className="flex items-center justify-center text-terminal-green"
        >
          {icon}
        </motion.div>
      </motion.div>
